						...
						<table class="table table-striped table-hover">
							<thead>
								<tr>
									...
									<th><span class="glyphicon glyphicon-pushpin"></span> <span class="visible-lg">手机号</span></th>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php echo $v['cal']; ?></td>
									<td><?php echo $v['updated_at']; ?></td>
									<td>
										<a rel="1" name="see" data-toggle="modal" data-target="#seeUser" >修改</a>
										<a rel="<?php echo $v['user_id']; ?>" name="delete" <?php if($v['name']=="admin"){?> style="pointer-events: none; color: #e8dde2; cursor: wait;" <?php } ?>  >删除</a>
