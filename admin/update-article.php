        ...
        <form action="" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <script id="article-content" name="content" type="text/plain"><?php echo $row['contents'] ?></script>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>关键字</span></h2>
              <div class="add-article-box-content">
              	<input type="text" class="form-control" placeholder="请输入关键字" value="<?php echo $row['keywords'] ?>" name="keywords" autocomplete="off">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="describe" autocomplete="off"><?php echo $row['des'] ?></textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <?php foreach($c as $k=>$c){  ?>
                  <li>
                    <label>
                      <input name="category" type="radio" value="<?php echo $c['cat_id'] ?>">
                      <?php echo $c['catname'] ?> <em class="hidden-md">( 栏目ID: <span><?php echo $c['cat_id'] ?></span> )</em></label>
                  </li>
                <?php }?>
                </ul>
              </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="输入新标签" value="<?php echo $row['tags'] ?>" name="tags" autocomplete="off">
                <span class="prompt-text">多个标签请用英文逗号,隔开</span> </div>
            </div>
            <div class="add-article-box">
              <h2 class="add-article-box-title"><span>标题图片</span></h2>
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="点击按钮选择图片" id="pictureUpload" name="titlepic" autocomplete="off" value="<?php echo $row['pic'] ?>">
              </div>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                ...
                <p><label>发布于：</label><span class="article-time-display"><input style="border: none;" type="datetime" name="time" value="<?php echo date('Y-m-d',$row['add_time']); ?>" /></span></p>
              </div>
              <div class="add-article-box-footer">
...
if ($("input[name='category']").get(index).value == <?php echo $row['cat_id'] ?>) {
